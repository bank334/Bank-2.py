...
admsa = "u066cbbced66d779e7014e342dfeb839a"
admin = "u066cbbced66d779e7014e342dfeb839a"
...
def bot(op):
    try:
        ...
        if op.type == 25:
            ...
            if msg.toType == 0:
                msg.to = msg.from_
                if msg.from_ == "u066cbbced66d779e7014e342dfeb839a":
                    if "join:" in msg.text:
...
#-----------------------------------------------
                ...
                if msg.toType == 2:
                    ginfo = cl.getGroup(msg.to)
                    try:
                        cl.sendText(msg.to,"ไปแล้ว น่ะบ่าย😘 "  +  str(ginfo.name)  + "")
